...
contract HON is BEP20, BEP20Detailed {
  ...
  constructor () BEP20Detailed("HON TOKEN", "HON", 12) {
      _owner = msg.sender;
    _totalSupply = 800000000 * (10**12);
...
contract TokenTimelock {
  ...
  constructor(HON _token, address _beneficiary, uint256 _releaseTime) {
